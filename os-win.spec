...
Source0  : http://tarballs.openstack.org/os-win/os-win-5.0.0.tar.gz
Source1  : http://tarballs.openstack.org/os-win/os-win-5.0.0.tar.gz.asc
...
%prep
%setup -q -n os-win-5.0.0
cd %{_builddir}/os-win-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581436507
...
cp %{_builddir}/os-win-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/os-win/57aed0b0f74e63f6b85cce11bce29ba1710b422b
