...
Source0  : http://tarballs.openstack.org/os-win/os-win-4.1.0.tar.gz
Source99 : http://tarballs.openstack.org/os-win/os-win-4.1.0.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1540478767
